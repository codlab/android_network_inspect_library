 ...
 */
@SuppressLint("NewApi")
public class TouchHandlerNewBack extends  ScaleGestureDetector.SimpleOnScaleGestureListener  implements ITouchHandler {
  /** The chart renderer. */
   ...
   */
  public TouchHandlerNewBack(GraphicalView view, AbstractChart chart) {
    graphicalView = view;
  ...
  public void removePanListener(PanListener listener) {
    ...
    public boolean onScale(ScaleGestureDetector detector) {
        //TODO manage scale for y
        applyZoom(detector.getScaleFactor(), Zoom.ZOOM_AXIS_X);
